...
os.chdir("/home/administrator/SLD_19/Garima/LID_files/test_LID/telLID")  #set the working directory
...
path = "/home/administrator/SLD_19/Garima/LID_files/test_LID/testtelLID_combined.csv"  # Path to save the concatted csv file
...
print("combined test telugu file :\n" ,combined_csv.head())
...
#..................combine combined_testTeluguFile with combined_testHindiFile

dfhin= pd.read_csv("/home/administrator/SLD_19/Garima/LID_files/test_LID/testhinLID_combined.csv")
dftel= pd.read_csv("/home/administrator/SLD_19/Garima/LID_files/test_LID/testhinLID_combined.csv")
hintelcombined_csv = pd.concat([dfhin, dftel])
hintelcombined_csv.to_csv("/home/administrator/SLD_19/Garima/LID_files/test_LID/testhintelLID_combined.csv", index= False, encoding= 'utf-8-sig')
